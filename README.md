...
Процесс **UC-2 «Расшифровка при известном ключе»**:

- пользователь выбирает режим расшифровки и указывает ключ (и опционально — образец);
- приложение валидирует пути;
- сервис читает зашифрованный текст;
- вызывается задача «Расшифровка»;
